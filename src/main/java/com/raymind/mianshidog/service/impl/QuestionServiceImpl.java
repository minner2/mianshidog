...
import com.raymind.mianshidog.mapper.QuestionMapper;
...
//            questionVO.setHasFavour(questionIdHasFavourMap.getOrDefault(questionVO.getId(), false));
    ...
    public Page<Question> listQuestionByPage(QuestionQueryRequest questionQueryRequest) {
        ...
        LambdaQueryWrapper<QuestionBankQuestion> lambdaQueryWrapper = new LambdaQueryWrapper<QuestionBankQuestion>()
                ...
                .eq(QuestionBankQuestion::getQuestionBankId, questionQueryRequest.getQuestionBankId());
        List<QuestionBankQuestion> bankQuestionList = questionBankQuestionService.list(lambdaQueryWrapper);
        if (CollectionUtils.isNotEmpty(bankQuestionList)) {
